...
public class TestEnableDisableFeaturesTest {
    ...
    public void testEDF2() throws Exception {
        ...
        serverEDF2.setServerConfigurationFile("server_monitor40.xml");
        // CWMPI2009I is SPECIFICALLY for mpMetrics-4.0 and monitor-1.0
        ...
        checkStrings(getHttpsServlet("/metrics/vendor", serverEDF2), new String[] {
                ...
                "vendor_servlet_responseTime_total_seconds{servlet=\"io_openliberty_microprofile_metrics_internal_private_PrivateMetricsRESTProxyServlet\"}",
                "vendor_servlet_request_total{servlet=\"io_openliberty_microprofile_metrics_internal_private_PrivateMetricsRESTProxyServlet\"}" },
                new String[] {});
    }
    ...
    public void testEDF5() throws Exception {
        ...
        checkStrings(getHttpsServlet("/metrics/vendor", serverEDF5), new String[] {
                "vendor_jaxws_client_checkedApplicationFaults_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_client_runtimeFaults_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_client_responseTime_total_seconds{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_client_invocations_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_client_uncheckedApplicationFaults_total_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_client_logicalRuntimeFaults_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_server_checkedApplicationFaults_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_server_runtimeFaults_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_server_responseTime_total_seconds{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_server_invocations_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_server_uncheckedApplicationFaults_total_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}",
                "vendor_jaxws_server_logicalRuntimeFaults_total{endpoint=\"jaxws.monitor_fat.internal.metrics.microprofile.openliberty.io..SimpleEchoService.SimpleEchoPort\"}" },
                new String[] {});
    }
